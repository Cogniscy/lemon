...
| MINE-style composite node/edge | Text→KG | no | yes | no | 0.8028 | node/edge/fact/corpus |
| MINE-style LLM fact recoverability | Text→KG | no | yes | yes | 0.5200 | node/edge/fact/corpus |
